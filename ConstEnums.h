...
enum ChallengePage
{
    ...
    CHALLENGE_PAGE_LIMBO_SURVIVAL = 1,
    CHALLENGE_PAGE_CHALLENGE = 2,
    CHALLENGE_PAGE_LIMBO_CHALLENGE = 3,
    CHALLENGE_PAGE_PUZZLE = 4,
    CHALLENGE_PAGE_LAST_STAND = 5,
    CHALLENGE_PAGE_CUSTOM_CHALLENGE = 6,
    CHALLENGE_PAGE_CUSTOM_CHALLENGE_2 = 7,
    MAX_CHALLANGE_PAGES = 8
};
enum ChallengeState
{
...
enum DrawVariation
{
    ...
    VARIATION_AQUARIUM,
    VARIATION_PUMPKINSHELL_FRONT,
    VARIATION_PUMPKINSHELL_BACK,
    VARIATION_NORMAL_DEGRADE1,
    VARIATION_NORMAL_DEGRADE2,
    VARIATION_PUMPKINSHELL_FRONT_DEGRADE1,
    VARIATION_PUMPKINSHELL_FRONT_DEGRADE2,
    VARIATION_KERNELPULT_WITH_BUTTER,
...
enum GameMode
{
    ...
    GAMEMODE_UPSELL,
    GAMEMODE_INTRO,
    GAMEMODE_SURVIVAL_NORMAL_STAGE_6,
    GAMEMODE_SURVIVAL_NORMAL_STAGE_HIGHGROUND,
    GAMEMODE_SURVIVAL_HARD_STAGE_6,
    GAMEMODE_SURVIVAL_HARD_STAGE_HIGHGROUND,
    GAMEMODE_SURVIVAL_ENDLESS_STAGE_6,
    GAMEMODE_SURVIVAL_ENDLESS_STAGE_HIGHGROUND,
    GAMEMODE_LAST_STAND_STAGE_1,
    GAMEMODE_LAST_STAND_STAGE_2,
    GAMEMODE_LAST_STAND_STAGE_3,
    GAMEMODE_LAST_STAND_STAGE_4,
    GAMEMODE_LAST_STAND_STAGE_5,
    GAMEMODE_LAST_STAND_ENDLESS_STAGE_1,
    GAMEMODE_LAST_STAND_ENDLESS_STAGE_2,
    GAMEMODE_LAST_STAND_ENDLESS_STAGE_3,
    GAMEMODE_LAST_STAND_ENDLESS_STAGE_4,
    GAMEMODE_LAST_STAND_ENDLESS_STAGE_5,
#ifdef _MOBILE_MINIGAMES
    GAMEMODE_CHALLENGE_VASEBREAKER,
    GAMEMODE_CHALLENGE_BUTTERED_POPCORN,
#endif
#ifdef _DS_MINIGAMES
    GAMEMODE_CHALLENGE_HEAT_WAVE,
    GAMEMODE_CHALLENGE_BOMB_ALL_TOGETHER,
    GAMEMODE_CHALLENGE_HOMERUN_DERBY,
    GAMEMODE_CHALLENGE_ZOMBIE_TRAP,
#endif
#ifdef _CONSOLE_MINIGAMES
    GAMEMODE_CHALLENGE_HEAVY_WEAPON,
#endif
    GAMEMODE_CHALLENGE_WORLD_7_1,
    GAMEMODE_CHALLENGE_WORLD_7_2,
    GAMEMODE_CHALLENGE_WORLD_7_3,
    GAMEMODE_CHALLENGE_WORLD_7_4,
    GAMEMODE_CHALLENGE_WORLD_7_5,
    GAMEMODE_CHALLENGE_WORLD_7_6,
    GAMEMODE_CHALLENGE_WORLD_7_7,
    GAMEMODE_CHALLENGE_WORLD_7_8,
    GAMEMODE_CHALLENGE_WORLD_7_9,
    GAMEMODE_CHALLENGE_WORLD_7_10,
    GAMEMODE_CHALLENGE_WAR_AND_PEAS_3,
    GAMEMODE_CHALLENGE_WAR_AND_PEAS_4,
    GAMEMODE_CHALLENGE_POGO_PARTY_2,
    GAMEMODE_CHALLENGE_POGO_PARTY_3,
    GAMEMODE_LAST_STAND_STAGE_6,
    GAMEMODE_LAST_STAND_ENDLESS_STAGE_6,
    GAMEMODE_SURVIVAL_NORMAL_STAGE_7,
    GAMEMODE_SURVIVAL_HARD_STAGE_7,
    GAMEMODE_SURVIVAL_ENDLESS_STAGE_7,
    GAMEMODE_CHALLENGE_VEHICLE_PARTY,
    GAMEMODE_CHALLENGE_SLOT_MACHINE_2,
    GAMEMODE_CHALLENGE_SLOT_MACHINE_3,
    GAMEMODE_CHALLENGE_SLOT_MACHINE_4,
    GAMEMODE_CHALLENGE_ZOMBIE_PARTY,
    GAMEMODE_CHALLENGE_WALLNUT_BOWLING_3,
    GAMEMODE_CHALLENGE_NIGHT_ROOF_MINIGAME,
    GAMEMODE_CHALLENGE_WORLD_8_1,
    GAMEMODE_CHALLENGE_WORLD_8_2,
    GAMEMODE_CHALLENGE_WORLD_8_3,
    GAMEMODE_CHALLENGE_WORLD_8_4,
    GAMEMODE_CHALLENGE_WORLD_8_5,
    GAMEMODE_CHALLENGE_WORLD_8_6,
    GAMEMODE_CHALLENGE_WORLD_8_7,
    GAMEMODE_CHALLENGE_WORLD_8_8,
    GAMEMODE_CHALLENGE_WORLD_8_9,
    GAMEMODE_CHALLENGE_WORLD_8_10,
    GAMEMODE_CHALLENGE_TRANSPARENT,
    GAMEMODE_CHALLENGE_WAR_AND_PEAS_NIGHTMARE,
    GAMEMODE_CHALLENGE_WAR_AND_PEAS_EXTREME_NIGHTMARE,
    GAMEMODE_SURVIVAL_NORMAL_STAGE_8,
    GAMEMODE_SURVIVAL_HARD_STAGE_8,
    GAMEMODE_SURVIVAL_ENDLESS_STAGE_8,
    GAMEMODE_CHALLENGE_LEVEL_EDITOR,
    NUM_GAME_MODES
};
enum GameObjectType
{
...
enum ProjectileMotion
{
    ...
    MOTION_STAR = 7,  // 斜向运动
    MOTION_FLOAT_OVER = 8,  // 缓慢漂浮向右（无碰撞） // Not Implemented?
    MOTION_HOMING = 9   // 追踪
};
enum ProjectileType
{
    ...
    PROJECTILE_ZOMBIE_CABBAGE,
    PROJECTILE_ZOMBIE_STAR,
...
enum ReanimationType : unsigned int {
    ...
    REANIM_FLAG,
    REANIM_TEXT_SLIDE_ON,
    REANIM_TEXT_SLIDE_DOWN,
    REANIM_ZOMBIE_BLACKFOOTBALL,
...
enum SeedType
{
    ...
    SEED_TIMESTOPPER,
    SEED_ICEBERGLETTUCE,
    SEED_CHERRYHOVERBOMB,
    SEED_STINGER,
    SEED_DUPLICATORCYCLER,
    SEED_BEEHIVE, // Conceptual
    SEED_YAMPOLINE,  // Conceptual
    SEED_NUKECUMBER, // Conceptual
#endif
    SEED_EXPLODE_O_NUT,
    SEED_GIANT_WALLNUT,
    SEED_SPROUT,
...
enum StoreItem
{
    ...
    STORE_ITEM_FIRSTAID,
    STORE_ITEM_PVZ,
    STORE_ITEM_PLANT_TIMESTOPPER,
    STORE_ITEM_PLANT_ICEBERGLETTUCE,
    STORE_ITEM_PLANT_CHERRYHOVERBOMB,
    STORE_ITEM_PLANT_STINGER,
    STORE_ITEM_PLANT_DUPLICATORCYCLER,
    STORE_ITEM_PLANT_BEEHIVE,
    STORE_ITEM_PLANT_YAMPOLINE,
    STORE_ITEM_PLANT_NUKECUMBER,
...
enum ZombiePhase
{
    ...
    PHASE_SNORKEL_UP_TO_EAT_ON_LAND,
    PHASE_SNORKEL_EATING_ON_LAND,
    PHASE_SNORKEL_DOWN_FROM_EAT_ON_LAND,
    ...
    PHASE_ZAMBONI_FLAT
#ifdef _HAS_BLOOM_AND_DOOM_CONTENTS
    ,PHASE_PROPELLER_FLYING,
    PHASE_PROPELLER_WALKING,
    PHASE_WALKING_DOG,
    PHASE_WALKING_WITHOUT_DOG,
    PHASE_DOG_LEASHED,
    PHASE_DOG_FREE
#endif
};
enum ZombieType
{
    ...
    ZOMBIE_POTATOMINE_HEAD,
    ZOMBIE_PUMPKIN_HEAD,
    ZOMBIE_CABBAGEPULT_HEAD,
    ZOMBIE_DOOR_TRAFFIC_CONE,
    ZOMBIE_DOOR_PAIL,
    ZOMBIE_BUNGEE_PAIL,
    ZOMBIE_POGO_PAIL,
    ZOMBIE_JACK_IN_THE_BOX_CRAZY,
    ZOMBIE_DANCER_COOL,
    ZOMBIE_NORMAL_VERY_HUNGRY,
    ZOMBIE_TRAFFIC_CONE_VERY_HUNGRY,
    ZOMBIE_PAIL_VERY_HUNGRY,
    ZOMBIE_SMASH_GARGANTUAR,
    ZOMBIE_NIGHTMARE_PEA_HEAD,
    ZOMBIE_NIGHTMARE_WALLNUT_HEAD,
    ZOMBIE_NIGHTMARE_JALAPENO_HEAD,
    ZOMBIE_NIGHTMARE_GATLING_HEAD,
    ZOMBIE_NIGHTMARE_SQUASH_HEAD,
    ZOMBIE_NIGHTMARE_TALLNUT_HEAD,
    ZOMBIE_NIGHTMARE_REPEATER_HEAD,
    ZOMBIE_NIGHTMARE_POTATOMINE_HEAD,
    ZOMBIE_NIGHTMARE_PUMPKIN_HEAD,
    ZOMBIE_NIGHTMARE_CABBAGEPULT_HEAD,
    ZOMBIE_EXTREME_NIGHTMARE_PEA_HEAD,
    ZOMBIE_EXTREME_NIGHTMARE_WALLNUT_HEAD,
    ZOMBIE_EXTREME_NIGHTMARE_JALAPENO_HEAD,
    ZOMBIE_EXTREME_NIGHTMARE_GATLING_HEAD,
    ZOMBIE_EXTREME_NIGHTMARE_SQUASH_HEAD,
    ZOMBIE_EXTREME_NIGHTMARE_TALLNUT_HEAD,
    ZOMBIE_EXTREME_NIGHTMARE_REPEATER_HEAD,
    ZOMBIE_EXTREME_NIGHTMARE_POTATOMINE_HEAD,
    ZOMBIE_EXTREME_NIGHTMARE_PUMPKIN_HEAD,
    ZOMBIE_EXTREME_NIGHTMARE_CABBAGEPULT_HEAD,
