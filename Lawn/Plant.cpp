...
PlantDefinition gPlantDefs[SeedType::NUM_SEED_TYPES] = {  //0x69F2B0
    ...
    { SeedType::SEED_PUFFSHROOM,        nullptr, ReanimationType::REANIM_PUFFSHROOM,    6,  25,      750,    PlantSubClass::SUBCLASS_SHOOTER,    150,    _S("PUFF_SHROOM") },
    ...
    { SeedType::SEED_ICESHROOM,         nullptr, ReanimationType::REANIM_ICESHROOM,     36, 100,     5000,   PlantSubClass::SUBCLASS_NORMAL,     0,      _S("ICE_SHROOM") },
    { SeedType::SEED_DOOMSHROOM,        nullptr, ReanimationType::REANIM_DOOMSHROOM,    20, 200,    5000,   PlantSubClass::SUBCLASS_NORMAL,     0,      _S("DOOM_SHROOM") },
    ...
    { SeedType::SEED_CACTUS,            nullptr, ReanimationType::REANIM_CACTUS,        15, 100,    750,    PlantSubClass::SUBCLASS_SHOOTER,    150,    _S("CACTUS") },
    ...
    { SeedType::SEED_MAGNETSHROOM,      nullptr, ReanimationType::REANIM_MAGNETSHROOM,  35, 50,    750,    PlantSubClass::SUBCLASS_NORMAL,     0,      _S("MAGNET_SHROOM") },
    ...
    { SeedType::SEED_UMBRELLA,          nullptr, ReanimationType::REANIM_UMBRELLALEAF,  23, 150,    750,    PlantSubClass::SUBCLASS_NORMAL,     0,      _S("UMBRELLA_LEAF") },
    ...
    { SeedType::SEED_GOLD_MAGNET,       nullptr, ReanimationType::REANIM_GOLD_MAGNET,   27, 25,     5000,   PlantSubClass::SUBCLASS_NORMAL,     0,      _S("GOLD_MAGNET") },
...
void Plant::DoRowAreaDamage(int theDamage, unsigned int theDamageFlags)
{
    ...
    while (mBoard->IterateZombies(aZombie))
    {
            ...
            ))
        {
            ...
            if (aZombie->mZombiePhase == ZombiePhase::PHASE_POLEVAULTER_POST_VAULT || aZombie->mZombieType == ZombieType::ZOMBIE_POGO || aZombie->mZombieType == ZombieType::ZOMBIE_POGO_PAIL &&
    ...
    else if (mState == PlantState::STATE_CHOMPER_BITING)
    {
        if (mStateCountdown == 0)
        {
            ...
            else
            {
                ...
                else if (aZombie->mZombieType == ZOMBIE_POGO || aZombie->mZombieType == ZOMBIE_POGO_PAIL)
                {
...
void Plant::MagnetShroomAttactItem(Zombie* theZombie)
{
    ...
    else if (theZombie->mZombieType == ZombieType::ZOMBIE_POGO || theZombie->mZombieType == ZombieType::ZOMBIE_POGO_PAIL)
    {
    ...
    else
    {
        ...
        while (mBoard->IterateZombies(aZombie))
        {
            ...
            if (aZombie->mZombiePhase == ZombiePhase::PHASE_DIGGER_TUNNELING ||
                ...
                aZombie->mZombieType == ZombieType::ZOMBIE_POGO_PAIL)
            {
...
void Plant::Fire(Zombie* theTargetZombie, int theRow, PlantWeapon thePlantWeapon)
{
        ...
        )
    {
        ...
        if (theTargetZombie)
        {
            ...
            if (theTargetZombie->mZombieType == ZombieType::ZOMBIE_POGO || theTargetZombie->mZombieType == ZombieType::ZOMBIE_POGO_PAIL &&
                theTargetZombie->mHasObject)
            {
                aRangeX -= 60.0f;
            }
    ...
    while (mBoard->IterateZombies(aZombie))
    {
           ...
           )
        {
            ...
            if (mSeedType == SeedType::SEED_CHOMPER)
            {
                ...
                if (aZombie->mZombiePhase == ZombiePhase::PHASE_POGO_BOUNCING ||
                    ((aZombie->mZombieType == ZombieType::ZOMBIE_BUNGEE || aZombie->mZombieType == ZombieType::ZOMBIE_BUNGEE_PAIL) &&
                        aZombie->mTargetCol == mPlantCol))
                {
                    continue;
                }
            ...
            if (mSeedType == SeedType::SEED_POTATOMINE)
            {
                ...
                if ((aZombie->mZombieType == ZombieType::ZOMBIE_POGO || aZombie->mZombieType == ZombieType::ZOMBIE_POGO_PAIL &&
                    aZombie->mHasObject) ||
                    aZombie->mZombiePhase == ZombiePhase::PHASE_POLEVAULTER_IN_VAULT || aZombie->mZombiePhase == ZombiePhase::PHASE_POLEVAULTER_PRE_VAULT)
                {
                    continue;
