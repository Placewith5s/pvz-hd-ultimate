...
MemoryImage* ReanimatorCache::MakeCachedZombieFrame(ZombieType theZombieType)
{
	...
	if (theZombieType == ZombieType::ZOMBIE_BUNGEE || theZombieType == ZombieType::ZOMBIE_BUNGEE_PAIL) maxHeight = 810;
	...
	else if (theZombieType == ZombieType::ZOMBIE_BUNGEE || theZombieType == ZombieType::ZOMBIE_BUNGEE_PAIL)
	{
		Reanimation aReanim;
	...
	else
	{
		...
		if (theZombieType == ZombieType::ZOMBIE_POGO || theZombieType == ZombieType::ZOMBIE_POGO_PAIL)
		{
