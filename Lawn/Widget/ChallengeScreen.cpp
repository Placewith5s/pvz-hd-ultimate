...
#endif
	{ GameMode::GAMEMODE_CHALLENGE_WORLD_7_1,             10,   ChallengePage::CHALLENGE_PAGE_CUSTOM_CHALLENGE,   0,  0,  _S("[7_1]") },
	{ GameMode::GAMEMODE_CHALLENGE_WORLD_7_2,             10,   ChallengePage::CHALLENGE_PAGE_CUSTOM_CHALLENGE,   0,  1,  _S("[7_2]") },
	{ GameMode::GAMEMODE_CHALLENGE_WORLD_7_3,             10,   ChallengePage::CHALLENGE_PAGE_CUSTOM_CHALLENGE,   0,  2,  _S("[7_3]") },
	{ GameMode::GAMEMODE_CHALLENGE_WORLD_7_4,             10,   ChallengePage::CHALLENGE_PAGE_CUSTOM_CHALLENGE,   0,  3,  _S("[7_4]") },
	{ GameMode::GAMEMODE_CHALLENGE_WORLD_7_5,             10,   ChallengePage::CHALLENGE_PAGE_CUSTOM_CHALLENGE,   0,  4,  _S("[7_5]") },
	{ GameMode::GAMEMODE_CHALLENGE_WORLD_7_6,             10,   ChallengePage::CHALLENGE_PAGE_CUSTOM_CHALLENGE,   1,  0,  _S("[7_6]") },
	{ GameMode::GAMEMODE_CHALLENGE_WORLD_7_7,             10,   ChallengePage::CHALLENGE_PAGE_CUSTOM_CHALLENGE,   1,  1,  _S("[7_7]") },
	{ GameMode::GAMEMODE_CHALLENGE_WORLD_7_8,             10,   ChallengePage::CHALLENGE_PAGE_CUSTOM_CHALLENGE,   1,  2,  _S("[7_8]") },
	{ GameMode::GAMEMODE_CHALLENGE_WORLD_7_9,             10,   ChallengePage::CHALLENGE_PAGE_CUSTOM_CHALLENGE,   1,  3,  _S("[7_9]") },
...
void ChallengeScreen::DrawButton(Graphics* g, int theChallengeIndex)
{
	...
	if (aChallengeButton->mVisible)
	{
		...
		if (aDef.mPage == CHALLENGE_PAGE_CHALLENGE ||
			aDef.mPage == CHALLENGE_PAGE_LIMBO_CHALLENGE || aDef.mPage == CHALLENGE_PAGE_PUZZLE)
...
void ChallengeScreen::Draw(Graphics* g)
{
	...
	int aTrophiesTotal = mPageIndex == CHALLENGE_PAGE_SURVIVAL ? 10 : mPageIndex == CHALLENGE_PAGE_CHALLENGE ? 20 : mPageIndex == CHALLENGE_PAGE_CUSTOM_CHALLENGE ? 12 : mPageIndex == CHALLENGE_PAGE_PUZZLE ? 18 : mPageIndex == CHALLENGE_PAGE_LAST_STAND ? 5 : 0;
	//int aTrophiesTotal = mPageIndex == CHALLENGE_PAGE_SURVIVAL ? 10 : mPageIndex == CHALLENGE_PAGE_CHALLENGE ? 31 : mPageIndex == CHALLENGE_PAGE_PUZZLE ? 18 : mPageIndex == CHALLENGE_PAGE_LAST_STAND ? 6 : 0;
	if (aTrophiesTotal > 0)
	{
