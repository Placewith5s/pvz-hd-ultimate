...
void GameSelector::KeyChar(char theChar)
{
	...
	if ((gIsPartnerBuild || mApp->mDebugKeysEnabled) && theChar == 'u' && mApp->mPlayerInfo)
	{
		...
		mApp->mPlayerInfo->mPurchases[StoreItem::STORE_ITEM_PLANT_TIMESTOPPER] = 1;
		mApp->mPlayerInfo->mPurchases[StoreItem::STORE_ITEM_PLANT_ICEBERGLETTUCE] = 1;
		mApp->mPlayerInfo->mPurchases[StoreItem::STORE_ITEM_PLANT_CHERRYHOVERBOMB] = 1;
		mApp->mPlayerInfo->mPurchases[StoreItem::STORE_ITEM_PLANT_STINGER] = 1;
		mApp->mPlayerInfo->mPurchases[StoreItem::STORE_ITEM_PLANT_DUPLICATORCYCLER] = 1;
		mApp->mPlayerInfo->mPurchases[StoreItem::STORE_ITEM_PLANT_BEEHIVE] = 1;
		mApp->mPlayerInfo->mPurchases[StoreItem::STORE_ITEM_PLANT_YAMPOLINE] = 1;
		mApp->mPlayerInfo->mPurchases[StoreItem::STORE_ITEM_PLANT_NUKECUMBER] = 1;
...
void GameSelector::AddPreviewProfiles()
{
	...
	if (aProfile)
	{
		...
		aProfile->mPurchases[StoreItem::STORE_ITEM_PLANT_TIMESTOPPER] = 1;
		aProfile->mPurchases[StoreItem::STORE_ITEM_PLANT_ICEBERGLETTUCE] = 1;
		aProfile->mPurchases[StoreItem::STORE_ITEM_PLANT_CHERRYHOVERBOMB] = 1;
		aProfile->mPurchases[StoreItem::STORE_ITEM_PLANT_STINGER] = 1;
		aProfile->mPurchases[StoreItem::STORE_ITEM_PLANT_DUPLICATORCYCLER] = 1;
		aProfile->mPurchases[StoreItem::STORE_ITEM_PLANT_BEEHIVE] = 1;
		aProfile->mPurchases[StoreItem::STORE_ITEM_PLANT_YAMPOLINE] = 1;
		aProfile->mPurchases[StoreItem::STORE_ITEM_PLANT_NUKECUMBER] = 1;
