...
ZombieDefinition gZombieDefs[NUM_ZOMBIE_TYPES] = {  //0x69DA80
    ...
    { ZOMBIE_DANCER,            REANIM_DANCER,              5,      18,     5,      2000,   _S("DANCING_ZOMBIE") },
    ...
    { ZOMBIE_JACK_IN_THE_BOX,   REANIM_JACKINTHEBOX,        3,      31,     10,     2000,   _S("JACK_IN_THE_BOX_ZOMBIE") },
    { ZOMBIE_BALLOON,           REANIM_BALLOON,             2,      33,     10,     2000,   _S("BALLOON_ZOMBIE") },
    { ZOMBIE_DIGGER,            REANIM_DIGGER,              4,      36,     10,     1000,   _S("DIGGER_ZOMBIE") },
    { ZOMBIE_POGO,              REANIM_POGO,                4,      38,     10,     2000,   _S("POGO_ZOMBIE") },
    { ZOMBIE_YETI,              REANIM_YETI,                4,      40,     1,      1,      _S("ZOMBIE_YETI") },
    { ZOMBIE_BUNGEE,            REANIM_BUNGEE,              3,      41,     10,     2000,   _S("BUNGEE_ZOMBIE") },
    ...
    { ZOMBIE_REPEATER_HEAD,      REANIM_ZOMBIE,              3,      48,     1,     3000,   _S("ZOMBIE") },
    ...
    { ZOMBIE_NIGHTMARE_PEA_HEAD,          REANIM_ZOMBIE,              1,      48,     1,      2000,   _S("ZOMBIE") },
    { ZOMBIE_NIGHTMARE_WALLNUT_HEAD,      REANIM_ZOMBIE_ZOMBOTANY,              4,      48,     1,      1500,   _S("ZOMBIE") },
    { ZOMBIE_NIGHTMARE_JALAPENO_HEAD,     REANIM_ZOMBIE_ZOMBOTANY,              3,      48,     10,     500,   _S("ZOMBIE") },
    { ZOMBIE_NIGHTMARE_GATLING_HEAD,      REANIM_ZOMBIE,              3,      48,     10,     1000,   _S("ZOMBIE") },
    { ZOMBIE_NIGHTMARE_SQUASH_HEAD,       REANIM_ZOMBIE,              3,      48,     10,     1000,   _S("ZOMBIE") },
    { ZOMBIE_NIGHTMARE_TALLNUT_HEAD,      REANIM_ZOMBIE_ZOMBOTANY,              4,      48,     10,     1000,   _S("ZOMBIE") },
    { ZOMBIE_NIGHTMARE_REPEATER_HEAD,      REANIM_ZOMBIE,              3,      48,     1,     1500,   _S("ZOMBIE") },
    ...
    { ZOMBIE_EXTREME_NIGHTMARE_GATLING_HEAD,      REANIM_ZOMBIE,              3,      48,     10,     500,   _S("ZOMBIE") },
    { ZOMBIE_EXTREME_NIGHTMARE_SQUASH_HEAD,       REANIM_ZOMBIE,              3,      48,     10,     500,   _S("ZOMBIE") },
    { ZOMBIE_EXTREME_NIGHTMARE_TALLNUT_HEAD,      REANIM_ZOMBIE_ZOMBOTANY,              4,      48,     10,     500,   _S("ZOMBIE") },
    { ZOMBIE_EXTREME_NIGHTMARE_REPEATER_HEAD,      REANIM_ZOMBIE,              3,      48,     1,     750,   _S("ZOMBIE") },
...
static ZombieType gBossZombieList[] = {  //0x69DE1C
    ...
    ZombieType::ZOMBIE_DOOR_TRAFFIC_CONE,
    ZombieType::ZOMBIE_DOOR_PAIL,
    ZombieType::ZOMBIE_BLACK_FOOTBALL,
...
void Zombie::ZombieInitialize(int theRow, ZombieType theType, bool theVariant, Zombie* theParentZombie, int theFromWave)
{
    ...
    case ZombieType::ZOMBIE_NORMAL_VERY_HUNGRY:
    {
    ...
    case ZombieType::ZOMBIE_DOOR_TRAFFIC_CONE:  //0x52280B
        LoadPlainZombieReanim();
        mHelmType = HelmType::HELMTYPE_TRAFFIC_CONE;
        mHelmHealth = 370;
        mShieldType = ShieldType::SHIELDTYPE_DOOR;
    ...
    case ZombieType::ZOMBIE_DOOR_PAIL:  // buckethead screen door
        LoadPlainZombieReanim();
        mHelmType = HelmType::HELMTYPE_BUCKET;
        mHelmHealth = 1100;
        mShieldType = ShieldType::SHIELDTYPE_DOOR;
    ...
    case ZombieType::ZOMBIE_BUNGEE_PAIL:  // bungee buckethead
    {
        mHelmType = HelmType::HELMTYPE_BUCKET;
        mHelmHealth = 1100;
        mBodyHealth = 450;
    ...
    case ZombieType::ZOMBIE_POGO_PAIL:  // pogo buckethead
        mHelmType = HelmType::HELMTYPE_BUCKET;
        mHelmHealth = 1100;
        mPosY -= 16;
        mVariant = false;
    ...
    case ZombieType::ZOMBIE_JACK_IN_THE_BOX_CRAZY:  // crazy jack in the box
    {
        mBodyHealth = 500;
        ...
        mPhaseCounter = (int)(aDistance / mVelX) * 4; // twice as fast limp speed factor
        ...
        Reanimation* aBodyReanim = mApp->ReanimationGet(mBodyReanimID);
        aBodyReanim->SetImageOverride("anim_head1", IMAGE_REANIM_ZOMBIE_JACKBOX_CRAZY_HEAD);
    ...
    case ZombieType::ZOMBIE_DANCER_COOL:  // cool dancing
        if (!IsOnBoard())
        {
            PlayZombieReanim("anim_moonwalk", ReanimLoopType::REANIM_LOOP, 0, 12.0f);
        }
    ...
    case ZombieType::ZOMBIE_EXTREME_NIGHTMARE_PUMPKIN_HEAD:
    {
        ...
        Reanimation* aBodyReanim = mApp->ReanimationGet(mBodyReanimID);
        ReanimatorTrackInstance* aTrackInstance = aBodyReanim->GetTrackInstanceByName("Zombie_zombotany_body");
        Reanimation* aHeadReanim = mApp->AddReanimation(0.0f, 0.0f, 0, ReanimationType::REANIM_PUMPKIN);
        aHeadReanim->PlayReanim("anim_idle", ReanimLoopType::REANIM_LOOP, 0, 15.0f);
        mSpecialHeadReanimID = mApp->ReanimationGetID(aHeadReanim);
        AttachEffect* aAttachEffect = AttachReanim(aTrackInstance->mAttachmentID, aHeadReanim, 0.0f, 0.0f);
        aBodyReanim->mFrameBasePose = 0;
...
int Zombie::CountBungeesTargetingSunFlowers()
{
    ...
    {
        if (!aZombie->IsDeadOrDying() && (aZombie->mZombieType == ZombieType::ZOMBIE_BUNGEE || aZombie->mZombieType == ZombieType::ZOMBIE_BUNGEE_PAIL)
            && aZombie->mTargetCol != -1)
        {
...
void Zombie::PickBungeePailZombieTarget(int theColumn)
{
    bool aAllowSunFlowerTarget = true;
    if (CountBungeesTargetingSunFlowers() == mBoard->CountSunFlowers() - 1)
    {
    ...
    for (int x = 0; x < MAX_GRID_SIZE_X; x++)
    {
        if (theColumn == -1 || theColumn == x)  // 限制仅能在 theColumn 列寻找目标，除非 theColumn 为 -1
        {
            for (int y = 0; y < MAX_GRID_SIZE_Y; y++)
            {
                ...
                if (!mBoard->BungeePailIsTargetingCell(x, y))
                {
                    aPicks[aPickCount].mX = x;
                    aPicks[aPickCount].mY = y;
                    aPicks[aPickCount].mWeight = aWeight;
...
void Zombie::PickRandomSpeed()
{
    ...
    else if (mZombieType == ZombieType::ZOMBIE_DANCER || mZombieType == ZombieType::ZOMBIE_DANCER_COOL ||
        mZombieType == ZombieType::ZOMBIE_BACKUP_DANCER ||
        mZombieType == ZombieType::ZOMBIE_POGO && IsBouncingPogo() || mZombieType == ZombieType::ZOMBIE_POGO_PAIL && IsBouncingPogo() ||
...
void Zombie::BungeeLiftTarget()
{
    ...
    while (mBoard->IterateZombies(aZombie))
    {
        if ((aZombie->mZombieType == ZombieType::ZOMBIE_BUNGEE || aZombie->mZombieType == ZombieType::ZOMBIE_BUNGEE_PAIL)
            && aZombie != this && aZombie->mTargetPlantID == mTargetPlantID)
        {
...
void Zombie::UpdateZombieCrazyJackInTheBox()
{
    if (mZombiePhase == ZombiePhase::PHASE_JACK_IN_THE_BOX_RUNNING)
    {
        if (mPhaseCounter <= 0 && mHasHead)
    ...
    else if (mZombiePhase == ZombiePhase::PHASE_JACK_IN_THE_BOX_POPPING)
    {
        ...
        {
            Reanimation* aBodyReanim = mApp->ReanimationGet(mBodyReanimID);
            aBodyReanim->SetImageOverride("anim_head2", IMAGE_REANIM_ZOMBIE_JACKBOX_CRAZY_HEAD2);
...
void Zombie::UpdateZombieSmashGargantuar()
{
    if (mZombiePhase == ZombiePhase::PHASE_GARGANTUAR_SMASHING)
    {
        Reanimation* aBodyReanim = mApp->ReanimationGet(mBodyReanimID);
    ...
    if (doSmash)
    {
        mZombiePhase = ZombiePhase::PHASE_GARGANTUAR_SMASHING;
        mApp->PlayFoley(FoleyType::FOLEY_LOW_GROAN);
        PlayZombieReanim("anim_smash", ReanimLoopType::REANIM_PLAY_ONCE_AND_HOLD, 20, 32.0f);
    }
}
...
void Zombie::UpdateZombiePotatomineHead()
{
    if (!mHasHead)
        return;
    ...
    if (mPhaseCounter <= 100 && mHasHead)
    {
        ...
        if (aBodyReanim && aSpecialHeadReanim)
        {
            ...
            aAttachment->mShakeOffsetX = RandRangeFloat(-1.0f, 1.0f);
            aAttachment->mShakeOffsetY = RandRangeFloat(-1.0f, 1.0f);
            aSpecialHeadReanim->SetFramesForLayer("anim_glow");
            PlantState::STATE_POTATO_RISING;
        }
    }
...
void Zombie::UpdateZombieCabbagepultHead()
{
    if (!mHasHead)
        return;
    ...
    else if (mPhaseCounter == 0)
    {
        ...
        {
            Projectile* aProjectile = mBoard->AddProjectile(aOriginX, aOriginY, mRenderOrder, mRow, ProjectileType::PROJECTILE_ZOMBIE_CABBAGE);
            if (mChilledCounter > 0 || mIceTrapCounter > 0) {
                aProjectile->mOverrideColor = Color(75, 75, 255);
                aProjectile->mExtraAdditiveColor = aProjectile->mOverrideColor;
                aProjectile->mEnableExtraAdditiveDraw = true;
...
void Zombie::SummonBackupDancersForCool()
{
    if (!mHasHead)
        return;

    for (int i = 0; i < NUM_BACKUP_DANCERS_FOR_COOL; i++)
    {
        Zombie* aZombie = mBoard->ZombieTryToGet(mFollowerZombieID[i]);
        if (aZombie == nullptr || aZombie && aZombie->IsDeadOrDying())
        {
...
bool Zombie::NeedsMoreBackupDancersForCool()
{
    for (int i = 0; i < NUM_BACKUP_DANCERS_FOR_COOL; i++)
    {
        Zombie* aZombie = mBoard->ZombieTryToGet(mFollowerZombieID[i]);
...
void Zombie::UpdateZombieDancerCool()
{
    if (mIsEating)
        return;
...
{
    if (mZombieType == ZombieType::ZOMBIE_POGO || mZombieType == ZombieType::ZOMBIE_POGO_PAIL)
        return;
...
bool Zombie::CanLoseBodyParts()
{
    return 
        ...
        mZombieType != ZombieType::ZOMBIE_BUNGEE_PAIL &&
        ...
        mZombieType != ZombieType::ZOMBIE_SMASH_GARGANTUAR &&
...
void Zombie::DropHead(unsigned int theDamageFlags)
{
    ...
    if (mZombieType == ZombieType::ZOMBIE_DANCER || mZombieType == ZombieType::ZOMBIE_DANCER_COOL)
    {
    ...
    else if (mZombieType == ZombieType::ZOMBIE_POGO || mZombieType == ZombieType::ZOMBIE_POGO_PAIL)
    {
        PogoBreak(0U);
    ...
    if (aParticle)
    {
        ...
        {
            aParticle->OverrideImage(nullptr, IMAGE_REANIM_ZOMBIE_JACKBOX_CRAZY_HEAD);
        }
...
void Zombie::SetupReanimForLostArm(unsigned int theDamageFlags)
{
    ...
    case ZombieType::ZOMBIE_DANCER_COOL:
    ...
    if (aBodyReanim)
    {
        ...
        case ZombieType::ZOMBIE_JACK_IN_THE_BOX:
            ...
            break;
        case ZombieType::ZOMBIE_JACK_IN_THE_BOX_CRAZY:
            GetTrackPosition("Zombie_jackbox_outerarm_lower", aPosX, aPosY);
            aBodyReanim->SetImageOverride("Zombie_jackbox_outerarm_lower", IMAGE_REANIM_ZOMBIE_JACKBOX_OUTERARM_LOWER2);
            break;
...
void Zombie::DropArm(unsigned int theDamageFlags)
{
    ...
    if (mShieldType == ShieldType::SHIELDTYPE_DOOR || mShieldType == ShieldType::SHIELDTYPE_TRASHCAN || mShieldType == ShieldType::SHIELDTYPE_NEWSPAPER ||
        mZombieType == ZombieType::ZOMBIE_BUNGEE || mZombieType == ZombieType::ZOMBIE_BUNGEE_PAIL)
    {
        return;
    }
...
void Zombie::UpdateZombieWalking()
{
    ...
    else
    {
        ...
        if (mZombiePhase == ZombiePhase::PHASE_POLEVAULTER_IN_VAULT ||
            ...
            mZombieType == ZombieType::ZOMBIE_DANCER_COOL ||
            mZombieType == ZombieType::ZOMBIE_BACKUP_DANCER ||
            mZombieType == ZombieType::ZOMBIE_BOBSLED ||
            mZombieType == ZombieType::ZOMBIE_POGO ||
            mZombieType == ZombieType::ZOMBIE_POGO_PAIL ||
...
{
    if (mZombieType == ZombieType::ZOMBIE_BUNGEE || mZombieType == ZombieType::ZOMBIE_BUNGEE_PAIL || mZombieType == ZombieType::ZOMBIE_BOSS ||
...
void Zombie::Update()
{
    ...
    if (doUpdate)
    {
        ...
        else
        {
            ...
            if (mZombieType == ZombieType::ZOMBIE_BUNGEE || mZombieType == ZombieType::ZOMBIE_BUNGEE_PAIL)
            {
                UpdateZombieBungee();
            }
            if (mZombieType == ZombieType::ZOMBIE_POGO || mZombieType == ZombieType::ZOMBIE_POGO_PAIL)
...
void Zombie::UpdateActions()
{
    ...
    if (mZombieType == ZombieType::ZOMBIE_JACK_IN_THE_BOX_CRAZY) {
        UpdateZombieCrazyJackInTheBox();
    }
    if (mZombieType == ZombieType::ZOMBIE_GARGANTUAR || mZombieType == ZombieType::ZOMBIE_REDEYE_GARGANTUAR)
    {
        UpdateZombieGargantuar();
    }
    if (mZombieType == ZombieType::ZOMBIE_SMASH_GARGANTUAR)
    {
        UpdateZombieSmashGargantuar();
    }
    ...
    if (mZombieType == ZombieType::ZOMBIE_DANCER_COOL)
    {
        UpdateZombieDancerCool();
    }
...
void Zombie::CheckForBoardEdge()
{
        ...
        )
    {
        ...
        mZombieType == ZombieType::ZOMBIE_DANCER || mZombieType == ZombieType::ZOMBIE_DANCER_COOL ||
        mZombieType == ZombieType::ZOMBIE_SNORKEL)
    {
        aEdgeX = -130;
    }
...
bool Zombie::HasYuckyFaceImage()
{
    ...
    return 
        !mBoard->mFutureMode && (mZombieType == ZombieType::ZOMBIE_NORMAL ||
            mZombieType == ZombieType::ZOMBIE_NORMAL_VERY_HUNGRY ||
            mZombieType == ZombieType::ZOMBIE_TRAFFIC_CONE ||
            mZombieType == ZombieType::ZOMBIE_TRAFFIC_CONE_VERY_HUNGRY ||
            mZombieType == ZombieType::ZOMBIE_PAIL ||
            mZombieType == ZombieType::ZOMBIE_PAIL_VERY_HUNGRY ||
            mZombieType == ZombieType::ZOMBIE_FLAG ||
            mZombieType == ZombieType::ZOMBIE_DOOR ||
            mZombieType == ZombieType::ZOMBIE_DOOR_TRAFFIC_CONE ||
...
void Zombie::Animate()
{
    ...
    if (mIsEating && mHasHead)
    {
        ...
        if (aBodyReanim)
        {
            ...
            else if (mZombieType == ZombieType::ZOMBIE_JACK_IN_THE_BOX || mZombieType == ZombieType::ZOMBIE_JACK_IN_THE_BOX_CRAZY)
            {
                aLeftHandTime = 0.53f;
...
#ifdef _HAS_NEW_DANCERS
    if (mZombieType == ZombieType::ZOMBIE_DANCER || mZombieType == ZombieType::ZOMBIE_DANCER_COOL ||
        mZombieType == ZombieType::ZOMBIE_BACKUP_DANCER) scaleMultiplier = 0.79872f;
#endif
...
void Zombie::DrawReanim(Graphics* g, const ZombieDrawPosition& theDrawPos, int theBaseRenderGroup)
{
    ...
    else if (mZombieType == ZombieType::ZOMBIE_BUNGEE || mZombieType == ZombieType::ZOMBIE_BUNGEE_PAIL)
    {
...
void Zombie::Draw(Graphics* g)
{
    ...
    if (mZombieType != ZombieType::ZOMBIE_BOSS && IsOnBoard() && mApp->mShowHealthBar && mHasHead && !IsDeadOrDying() && !mApp->IsWhackAZombieLevel() &&
        ...
        int HEALTH_POSY = (mHelmType != HelmType::HELMTYPE_NONE || mZombieType == ZombieType::ZOMBIE_FOOTBALL 
            ...
            || mZombieType == ZombieType::ZOMBIE_BLACK_FOOTBALL 
#endif
            || (mZombieType == ZombieType::ZOMBIE_DANCER || mZombieType == ZombieType::ZOMBIE_DANCER_COOL) ? -30 : -15) - mAltitude + (int)((1.0f - aScale) * 120);
        ...
        if (mZombieType == ZombieType::ZOMBIE_GARGANTUAR || mZombieType == ZombieType::ZOMBIE_REDEYE_GARGANTUAR ||
            mZombieType == ZombieType::ZOMBIE_SMASH_GARGANTUAR) HEALTH_POSY -= 60;
...
void Zombie::UpdateAnimSpeed()
{
    ...
    if (mIsEating)
    {
        if (mZombieType == ZombieType::ZOMBIE_POLEVAULTER || mZombieType == ZombieType::ZOMBIE_BALLOON || mZombieType == ZombieType::ZOMBIE_IMP || 
            mZombieType == ZombieType::ZOMBIE_DIGGER || mZombieType == ZombieType::ZOMBIE_JACK_IN_THE_BOX || mZombieType == ZombieType::ZOMBIE_JACK_IN_THE_BOX_CRAZY ||
            mZombieType == ZombieType::ZOMBIE_SNORKEL ||
...
void Zombie::StartWalkAnim(int theBlendTime)
{
    ...
    else if (mZombieType == ZombieType::ZOMBIE_DANCER || mZombieType == ZombieType::ZOMBIE_DANCER_COOL || mZombieType == ZombieType::ZOMBIE_BACKUP_DANCER)
    {
        PlayZombieReanim("anim_walk", ReanimLoopType::REANIM_LOOP, 20, 18.0f);
    }
    else
...
void Zombie::EatPlant(Plant* thePlant)
{
    ...
    if (mZombieType == ZombieType::ZOMBIE_NORMAL_VERY_HUNGRY ||
        mZombieType == ZombieType::ZOMBIE_TRAFFIC_CONE_VERY_HUNGRY ||
        mZombieType == ZombieType::ZOMBIE_PAIL_VERY_HUNGRY)
    {
        const int DOUBLE_DAMAGE_PER_EAT = 8;
        thePlant->mPlantHealth -= DOUBLE_DAMAGE_PER_EAT;
    }
...
bool Zombie::TrySpawnLevelAward()
{
    ...
    else if (mApp->IsAdventureMode() && mBoard->mLevel <= 60)
    {
        ...
        else if (mBoard->mLevel >= 49 && mBoard->mLevel <= 58 || mApp->HasFinishedAdventure())
        {
            aCoinType = CoinType::COIN_AWARD_MONEY_BAG;
        }
        else if (mBoard->mLevel == 9 || mBoard->mLevel == 19 || mBoard->mLevel == 29 || mBoard->mLevel == 39 || mBoard->mLevel == 59)
        {
    ...
    if (mApp->IsAdventureMode() && mApp->mPlayerInfo->GetLevel() % 5 != 0) 
    {
        ...
        if (!mBoard->mHadPlantedNuts && mBoard->StageIsNight() && mBoard->mLevel > 3) 
        {
...
void Zombie::StopZombieSound()
{
    ...
    if (mPlayingSong)
    {
        ...
        if (mZombieType == ZombieType::ZOMBIE_JACK_IN_THE_BOX || mZombieType == ZombieType::ZOMBIE_JACK_IN_THE_BOX_CRAZY)
        {
...
int Zombie::TakeHelmDamage(int theDamage, unsigned int theDamageFlags)
{
    ...
    if (aDamageIndexBeforeDamage != aDamageIndexAfterDamage)
    {
        ...
        else if (mHelmType == HelmType::HELMTYPE_PUMPKIN && aDamageIndexAfterDamage == 1)
        {
            Reanimation* aHeadReanim = mApp->ReanimationGet(mSpecialHeadReanimID);
            aHeadReanim->SetImageOverride("Pumpkin_front", IMAGE_REANIM_PUMPKIN_DAMAGE1);
        }
        else if (mHelmType == HelmType::HELMTYPE_PUMPKIN && aDamageIndexAfterDamage == 2)
        {
            Reanimation* aHeadReanim = mApp->ReanimationGet(mSpecialHeadReanimID);
            aHeadReanim->SetImageOverride("Pumpkin_front", IMAGE_REANIM_PUMPKIN_DAMAGE3);
        }
    }
...
bool Zombie::CanBeFrozen()
{
    ...
    return (mZombieType != ZombieType::ZOMBIE_BUNGEE && mZombieType != ZombieType::ZOMBIE_BUNGEE_PAIL) || mZombiePhase == ZombiePhase::PHASE_BUNGEE_AT_BOTTOM;
}
...
bool Zombie::EffectedByDamage(unsigned int theDamageRangeFlags)
{
    ...
    if ((mZombieType == ZombieType::ZOMBIE_BUNGEE || mZombieType == ZombieType::ZOMBIE_BUNGEE_PAIL) && mZombiePhase != ZombiePhase::PHASE_BUNGEE_AT_BOTTOM && mZombiePhase != ZombiePhase::PHASE_BUNGEE_GRABBING)
    {
...
bool Zombie::ZombieTypeCanGoInPool(ZombieType theZombieType)
{
    return 
        ...
        theZombieType == ZombieType::ZOMBIE_NORMAL_VERY_HUNGRY ||
        theZombieType == ZombieType::ZOMBIE_TRAFFIC_CONE_VERY_HUNGRY ||
        theZombieType == ZombieType::ZOMBIE_PAIL_VERY_HUNGRY ||
...
void Zombie::ApplyButter()
{
    ...
    Zombie* aZombie = mBoard->ZombieTryToGet(mRelatedZombieID);
    if (aZombie && aZombie->mZombieType != ZombieType::ZOMBIE_DANCER && aZombie->mZombieType != ZombieType::ZOMBIE_DANCER_COOL &&
...
void Zombie::ApplyBurn()
{
    ...
    else if (mZombieType == ZOMBIE_BUNGEE || mZombieType == ZOMBIE_BUNGEE_PAIL || mZombieType == ZOMBIE_YETI ||
        Zombie::IsZombotany(mZombieType) || IsBobsledTeamWithSled() || IsFlying() || !mHasHead
#ifdef _HAS_BLOOM_AND_DOOM_CONTENTS
        || mZombieType == ZombieType::ZOMBIE_DOG
#endif
        )
    ...
    else
    {
        ...
        else if (mZombieType == ZombieType::ZOMBIE_DIGGER)
        {
            ...
            mZombieType == ZombieType::ZOMBIE_SMASH_GARGANTUAR) && !mHasObject)
        {
...
void Zombie::PlayDeathAnim(unsigned int theDamageFlags)
{
    ...
    if (TestBit(theDamageFlags, (int)DamageFlags::DAMAGE_DOESNT_LEAVE_BODY))
    {
        if (mZombieType != ZombieType::ZOMBIE_BOSS && mZombieType != ZombieType::ZOMBIE_GARGANTUAR &&
            mZombieType != ZombieType::ZOMBIE_SMASH_GARGANTUAR && mZombieType != ZombieType::ZOMBIE_REDEYE_GARGANTUAR)
        {
            DieNoLoot();
            return;
        }
...
void Zombie::DoDaisies()
{
    ...
    if (mZombieType == ZombieType::ZOMBIE_FOOTBALL || mZombieType == ZombieType::ZOMBIE_DANCER || mZombieType == ZombieType::ZOMBIE_DANCER_COOL ||
        mZombieType == ZombieType::ZOMBIE_BACKUP_DANCER
#ifdef _HAS_NEW_GIGA_ZOMBIES
        || mZombieType == ZombieType::ZOMBIE_BLACK_FOOTBALL
#endif
...
void Zombie::DrawShadow(Graphics* g)
{
    ...
    if (mZombieHeight == ZombieHeight::HEIGHT_UP_LADDER || mZombieHeight == ZombieHeight::HEIGHT_FALLING || 
        mZombiePhase == ZombiePhase::PHASE_IMP_GETTING_THROWN || mZombieType == ZombieType::ZOMBIE_BUNGEE || mZombieType == ZombieType::ZOMBIE_BUNGEE_PAIL
        || IsBouncingPogo() || IsFlying())
    {
...
void Zombie::BossSpawnContact()
{
    if (mApp->mGameMode == GAMEMODE_CHALLENGE_WORLD_7_10)
    {
        ZombieType gBossZombieList[] = {
            ...
            ZombieType::ZOMBIE_BLACK_FOOTBALL,
            ZombieType::ZOMBIE_REDEYE_GARGANTUAR,
            ZombieType::ZOMBIE_POGO_PAIL,
            ZombieType::ZOMBIE_JACK_IN_THE_BOX_CRAZY,
            ZombieType::ZOMBIE_DANCER_COOL,
            ZombieType::ZOMBIE_GARGANTUAR
        };
    }
    else if (mApp->mGameMode == GAMEMODE_CHALLENGE_WORLD_8_10)
    {
        ZombieType gBossZombieList[] = {
            ZombieType::ZOMBIE_TRAFFIC_CONE,
            ZombieType::ZOMBIE_PAIL,
            ...
            ZombieType::ZOMBIE_JACK_IN_THE_BOX_CRAZY,
            ZombieType::ZOMBIE_DANCER_COOL,
            ZombieType::ZOMBIE_NORMAL_VERY_HUNGRY,
            ZombieType::ZOMBIE_TRAFFIC_CONE_VERY_HUNGRY,
            ZombieType::ZOMBIE_PAIL_VERY_HUNGRY,
            ZombieType::ZOMBIE_SMASH_GARGANTUAR,
            ZombieType::ZOMBIE_GARGANTUAR
        };
    }
    else
...
bool Zombie::PreloadZombieResources(ZombieType theZombieType)
{
    ...
    else if (theZombieType == ZombieType::ZOMBIE_DANCER || theZombieType == ZombieType::ZOMBIE_DANCER_COOL)
    {
        ...
        theZombieType == ZombieType::ZOMBIE_SMASH_GARGANTUAR)
    {
...
{
    if (mZombieType != ZombieType::ZOMBIE_POGO && mZombieType != ZombieType::ZOMBIE_POGO_PAIL)   return;
...
{
    if (mZombieType != ZombieType::ZOMBIE_JACK_IN_THE_BOX && mZombieType != ZombieType::ZOMBIE_JACK_IN_THE_BOX_CRAZY)   return;
