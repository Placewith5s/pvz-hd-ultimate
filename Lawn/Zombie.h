...
#define MAX_ZOMBIE_FOLLOWERS 12
#define NUM_BOBSLED_FOLLOWERS 3
#define NUM_BACKUP_DANCERS 4
#define NUM_BACKUP_DANCERS_FOR_COOL NUM_BACKUP_DANCERS * 3
#define NUM_BOSS_BUNGEES 3

constexpr const int ZOMBIE_START_RANDOM_OFFSET = 40;
constexpr const int BUNGEE_ZOMBIE_HEIGHT = 3000;

constexpr const int RENDER_GROUP_HELMET = 1;
constexpr const int RENDER_GROUP_OVER_HELMET = 2;
constexpr const int RENDER_GROUP_SHIELD = 3;
constexpr const int RENDER_GROUP_ARMS = 4;
constexpr const int RENDER_GROUP_OVER_SHIELD = 5;
constexpr const int RENDER_GROUP_BOSS_BACK_LEG = 6;
constexpr const int RENDER_GROUP_BOSS_FRONT_LEG = 7;
constexpr const int RENDER_GROUP_BOSS_BACK_ARM = 8;
constexpr const int RENDER_GROUP_BOSS_FIREBALL_ADDITIVE = 9;
constexpr const int RENDER_GROUP_BOSS_FIREBALL_TOP = 10;
...
public:
    ...
    bool                            mZamboniFall;
    int                             mYampolineCounter;
    float                           mYampolineVelX;
    float                           mYampolineZ;
...
public:
    ...
    void                            PickBungeePailZombieTarget(int theColumn);
    ...
    void                            UpdateZombieCrazyJackInTheBox();
    ...
    bool                            NeedsMoreBackupDancersForCool();
    ...
    static bool                     PreloadZombieResources(ZombieType theZombieType);
    void                            BossStartDeath();
