...
bool Sexy::ExtractResourcesByName(ResourceManager* theResourceManager, const char* theName)
{
	...
	else if (!strcmp(theName, "DelayLoad_Zombatar"))			return ExtractDelayLoad_ZombatarResources(theResourceManager);
	else if (!strcmp(theName, "DelayLoad_LevelSelector"))		return ExtractDelayLoad_LevelSelectorResources(theResourceManager);
	else return false;
}
...
Image* Sexy::IMAGE_BOMB_INDICATOR;
Image* Sexy::IMAGE_STRIPECROWS;
Image* Sexy::IMAGE_CAGEICON;
Image* Sexy::IMAGE_ZOMBIEMETALGEAR;
...
Image* Sexy::IMAGE_REANIM_ZOMBIE_JACKBOX_CRAZY_HEAD;
Image* Sexy::IMAGE_REANIM_ZOMBIE_JACKBOX_CRAZY_HEAD2;
...
Image* Sexy::IMAGE_SCROLLBG;
Image* Sexy::IMAGE_SCROLLOVERLAY;
...
Image* Sexy::IMAGE_UNLOCK_BUTTON;
Image* Sexy::IMAGE_UNLOCK_BUTTON_HIGHLIGHT;
...
bool Sexy::ExtractLoadingImagesResources(ResourceManager* theManager)
{
	...
	try
	{
		...
		IMAGE_BOMB_INDICATOR = aMgr.GetImageThrow("IMAGE_BOMB_INDICATOR");
		IMAGE_STRIPECROWS = aMgr.GetImageThrow("IMAGE_STRIPECROWS");
		IMAGE_CAGEICON = aMgr.GetImageThrow("IMAGE_CAGEICON");
		IMAGE_ZOMBIEMETALGEAR = aMgr.GetImageThrow("IMAGE_ZOMBIEMETALGEAR");
...
//#endif
		...
		IMAGE_REANIM_ZOMBIE_JACKBOX_CRAZY_HEAD = aMgr.GetImageThrow("IMAGE_REANIM_ZOMBIE_JACKBOX_CRAZY_HEAD");
		IMAGE_REANIM_ZOMBIE_JACKBOX_CRAZY_HEAD2 = aMgr.GetImageThrow("IMAGE_REANIM_ZOMBIE_JACKBOX_CRAZY_HEAD2");
		...
		IMAGE_SCROLLBG = aMgr.GetImageThrow("IMAGE_SCROLLBG");
		IMAGE_SCROLLOVERLAY = aMgr.GetImageThrow("IMAGE_SCROLLOVERLAY");
		...
		IMAGE_UNLOCK_BUTTON = aMgr.GetImageThrow("IMAGE_UNLOCK_BUTTON");
		IMAGE_UNLOCK_BUTTON_HIGHLIGHT = aMgr.GetImageThrow("IMAGE_UNLOCK_BUTTON_HIGHLIGHT");
...
void* gResources[(int)Sexy::ResourceId::RESOURCE_ID_MAX] =
{
	...
	&Sexy::IMAGE_REANIM_ZOMBIE_JACKBOX_CRAZY_HEAD,
	&Sexy::IMAGE_REANIM_ZOMBIE_JACKBOX_CRAZY_HEAD2,
	...
	&Sexy::IMAGE_SCROLLBG,
	&Sexy::IMAGE_SCROLLOVERLAY,
	&Sexy::IMAGE_PAUSE_BUTTON,
	&Sexy::IMAGE_PAUSE_BUTTON_PRESSED,
	&Sexy::IMAGE_SPEEDUP_BUTTON,
	&Sexy::IMAGE_SPEEDUP_BUTTON_PRESSED,
	&Sexy::IMAGE_SLOWDOWN_BUTTON,
	&Sexy::IMAGE_SLOWDOWN_BUTTON_PRESSED,
	...
	&Sexy::IMAGE_BOMB_INDICATOR,
	&Sexy::IMAGE_STRIPECROWS,
	&Sexy::IMAGE_CAGEICON,
	&Sexy::IMAGE_ZOMBIEMETALGEAR,
	/* 0x69EA3C */
	...
	&Sexy::IMAGE_RIP_LEVER_HOLDER,
	&Sexy::IMAGE_RIP_LEVER_STICK,
	&Sexy::IMAGE_RIP_LEVER_STICK_PRESSED,
	&Sexy::IMAGE_UNLOCK_BUTTON,
	&Sexy::IMAGE_UNLOCK_BUTTON_HIGHLIGHT,
	&Sexy::IMAGE_UNLOCK_BUTTON_PRESSED,
};
...
Image* Sexy::IMAGE_RIP_LEVER_HOLDER;
Image* Sexy::IMAGE_RIP_LEVER_STICK;
Image* Sexy::IMAGE_RIP_LEVER_STICK_PRESSED;

bool Sexy::ExtractDelayLoad_LevelSelectorResources(ResourceManager* theManager)
{
#ifndef _HAS_LEVELSELECTOR
	return true;
#endif
	...
	try
	{
		...
		IMAGE_RIP_LEVER_HOLDER = aMgr.GetImageThrow("IMAGE_RIP_LEVER_HOLDER");
		IMAGE_RIP_LEVER_STICK = aMgr.GetImageThrow("IMAGE_RIP_LEVER_STICK");
		IMAGE_RIP_LEVER_STICK_PRESSED = aMgr.GetImageThrow("IMAGE_RIP_LEVER_STICK_PRESSED");
	}
	catch (ResourceManagerException&)
	{
		return false;
